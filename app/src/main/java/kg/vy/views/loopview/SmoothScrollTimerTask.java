...
final class SmoothScrollTimerTask implements Runnable {
    ...
    SmoothScrollTimerTask(kg.vy.views.loopview.LoopView loopview, int offset) {
    ...
    public final void run() {
        ...
        if (Math.abs(realTotalOffset) <= 0) {
            ...
            loopView.handler.sendEmptyMessage(kg.vy.views.loopview.MessageHandler.WHAT_ITEM_SELECTED);
        } else {
